...
export const dict = {
  ...
  "command.plugin.manager": "Manage plugins",
  "command.plugin.manager.description": "List, install, and remove plugins",
  ...
  "command.session.goalLoop.ticket": "Start goal loop from ticket",
  "command.session.goalLoop.ticket.description": "Pick a Linear ticket and work it to done",
  "command.session.goalWizard": "Goal loop wizard",
  "command.session.goalWizard.description": "Pick Linear tickets and run them one by one",

  "dialog.goalTicket.title": "Start goal loop from ticket",
  "dialog.goalTicket.searchPlaceholder": "Search tickets...",
  "dialog.goalTicket.empty": "No tickets found",
  "dialog.goalTicket.start": "Start",
  "dialog.goalTicket.unavailable": "Linear tickets are unavailable on this platform.",

  "dialog.goalWizard.title": "Goal loop wizard",
  "dialog.goalWizard.step1": "Team",
  "dialog.goalWizard.step2": "Tickets",
  "dialog.goalWizard.step3": "Instructions",
  "dialog.goalWizard.step4": "Review",
  "dialog.goalWizard.team.title": "Choose a team",
  "dialog.goalWizard.team.mine": "My tickets",
  "dialog.goalWizard.team.empty": "No teams found",
  "dialog.goalWizard.tickets.title": "Choose tickets",
  "dialog.goalWizard.tickets.selectAll": "Select all",
  "dialog.goalWizard.tickets.clear": "Clear",
  "dialog.goalWizard.tickets.empty": "No tickets found",
  "dialog.goalWizard.instructions.label": "Run instructions",
  "dialog.goalWizard.instructions.placeholder": "Extra instructions for each ticket (optional)...",
  "dialog.goalWizard.review.title": "Review",
  "dialog.goalWizard.review.team": "Team",
  "dialog.goalWizard.review.tickets": "{{count}} tickets",
  "dialog.goalWizard.review.directory": "Directory",
  "dialog.goalWizard.review.instructions": "Instructions",
  "dialog.goalWizard.review.none": "None",
  "dialog.goalWizard.review.empty": "Select at least one ticket",
  "dialog.goalWizard.action.back": "Back",
  "dialog.goalWizard.action.next": "Next",
  "dialog.goalWizard.action.startQueue": "Start queue",
  "dialog.goalWizard.action.stopQueue": "Stop queue",
  "dialog.goalWizard.unavailable": "Goal queue is unavailable on this platform.",
  ...
  "dialog.goalLoop.queue.header": "Goal loop",
  ...
  "goalPanel.idle": "No goal loop in this session",
  "goalPanel.header": "Goal · {{title}}",
  "goalPanel.state.turn": "Running · turn",
  "goalPanel.state.waiting": "Running · waiting",
  "goalPanel.state.completed": "Done",
  ...
  "goalPanel.verdict.pass": "Verified: PASS",
  "goalPanel.verdict.partial": "Verifier: PARTIAL",
  "goalPanel.verdict.fail": "Verifier: FAIL",
  "goalPanel.verdict.unmet": "Not met: {{criteria}}",
  "goalPanel.verifications": "{{count}} verifications without a PASS",
  "goalPanel.pendingChecks": "Proposed checks need your approval before they run:",
  "goalPanel.pendingChecks.approve": "Approve",
  "goalPanel.action.start": "Start goal loop",
  "goalPanel.action.stop": "Stop",
  "goalPanel.action.dismiss": "Dismiss",
  "goalPanel.action.more": "Show all",
  "goalPanel.action.less": "Show less",
  "goalPanel.iteration": "Iteration {{current}} of {{max}}",
  "goalPanel.iteration.unbounded": "Iteration {{current}}",
  "goalPanel.checked": "checked {{ago}} ago",
  "goalPanel.prompted": "last nudge {{ago}} ago",
  "goalPanel.badge": "Goal loop running",
  ...
  "toast.goalQueue.started.title": "Goal queue started",
  "toast.goalQueue.started.description": "{{count}} tickets queued.",
  "toast.goalQueue.completed.title": "Goal queue complete",
  "toast.goalQueue.completed.description": "{{count}} tickets completed.",
  "toast.goalQueue.halted.title": "Goal queue stopped",
  "toast.goalQueue.halted.description": "{{reason}}",

  "linear.settings.title": "Linear",
  "linear.settings.description": "Connect Linear with a personal API key stored securely on this device.",
  "linear.settings.apiKey.title": "API key",
  "linear.settings.apiKey.description": "Personal Linear API key, stored only on this device.",
  "linear.settings.apiKey.placeholder": "lin_api_...",
  "linear.settings.apiKey.show": "Show",
  "linear.settings.apiKey.hide": "Hide",
  "linear.settings.action.save": "Save",
  "linear.settings.action.clear": "Clear",
  "linear.settings.action.test": "Test connection",
  "linear.settings.status.title": "Status",
  "linear.settings.status.connected": "Connected as {{name}} ({{email}})",
  "linear.settings.status.disconnected": "Not connected",
  "linear.settings.status.checking": "Checking connection...",
  ...
  "dialog.mcp.install.open": "Add MCP server",
  "dialog.mcp.install.title": "Add MCP server",
  "dialog.mcp.install.description": "Connect a local command or remote URL as a Model Context Protocol server.",
  "dialog.mcp.install.name.label": "Name",
  "dialog.mcp.install.name.placeholder": "my-server",
  "dialog.mcp.install.name.empty": "Server name is required",
  "dialog.mcp.install.type.label": "Server type",
  "dialog.mcp.install.type.local": "Local (command)",
  "dialog.mcp.install.type.remote": "Remote (URL)",
  "dialog.mcp.install.command.label": "Command",
  "dialog.mcp.install.command.placeholder": "bun x my-server --stdio",
  "dialog.mcp.install.command.description": "Command and arguments, separated by spaces.",
  "dialog.mcp.install.command.empty": "Command is required for local servers",
  "dialog.mcp.install.cwd.label": "Working directory",
  "dialog.mcp.install.cwd.placeholder": "Optional, defaults to the workspace",
  "dialog.mcp.install.url.label": "Server URL",
  "dialog.mcp.install.url.placeholder": "https://example.com/mcp",
  "dialog.mcp.install.url.empty": "URL is required for remote servers",
  "dialog.mcp.install.env.label": "Environment variables",
  "dialog.mcp.install.env.add": "Add variable",
  "dialog.mcp.install.env.key.label": "Variable name",
  "dialog.mcp.install.env.key.placeholder": "KEY",
  "dialog.mcp.install.env.value.label": "Value",
  "dialog.mcp.install.env.value.placeholder": "value",
  "dialog.mcp.install.env.remove": "Remove variable",
  "dialog.mcp.install.headers.label": "HTTP headers",
  "dialog.mcp.install.headers.add": "Add header",
  "dialog.mcp.install.headers.key.label": "Header name",
  "dialog.mcp.install.headers.key.placeholder": "Authorization",
  "dialog.mcp.install.headers.value.label": "Value",
  "dialog.mcp.install.headers.value.placeholder": "Bearer ...",
  "dialog.mcp.install.headers.remove": "Remove header",
  "dialog.mcp.install.oauth.label": "OAuth",
  "dialog.mcp.install.oauth.description": "Request OAuth authentication when connecting.",
  "dialog.mcp.install.oauth.clientId.label": "Client ID",
  "dialog.mcp.install.oauth.clientId.placeholder": "Optional, dynamic registration otherwise",
  "dialog.mcp.install.oauth.clientSecret.label": "Client secret",
  "dialog.mcp.install.oauth.clientSecret.placeholder": "Optional",
  "dialog.mcp.install.oauth.scope.label": "Scope",
  "dialog.mcp.install.oauth.scope.placeholder": "Optional OAuth scopes",
  "dialog.mcp.install.oauth.callbackPort.label": "Callback port",
  "dialog.mcp.install.oauth.callbackPort.placeholder": "19876",
  "dialog.mcp.install.oauth.callbackPort.invalid": "Callback port must be a number between 1 and 65535",
  "dialog.mcp.install.oauth.redirectUri.label": "Redirect URI",
  "dialog.mcp.install.oauth.redirectUri.placeholder": "Optional, defaults to 127.0.0.1 callback",
  "dialog.mcp.install.scope.label": "Install scope",
  "dialog.mcp.install.scope.global": "Global (all projects)",
  "dialog.mcp.install.scope.local": "Local (this project)",
  "dialog.mcp.install.submit": "Add server",
  "dialog.mcp.install.installing": "Adding…",
  "dialog.mcp.remove.open": "Remove {{name}}",
  "dialog.mcp.remove.title": "Remove {{name}}?",
  "dialog.mcp.remove.description":
    "Deletes the server from every config that defines it. Re-adding requires its connection details.",
  ...
  "dialog.plugin.empty": "No plugins installed",
  "dialog.plugin.readd": "Reinstall",
  "dialog.plugin.removed.title": "Recently removed",
  "dialog.plugin.install.open": "Install plugin",
  "dialog.plugin.install.title": "Install plugin",
  "dialog.plugin.install.description": "Add a plugin from an npm package, local path, or URL.",
  "dialog.plugin.install.spec.label": "Plugin",
  "dialog.plugin.install.spec.placeholder": "acme@1.2.3",
  "dialog.plugin.install.scope.label": "Install scope",
  "dialog.plugin.install.scope.global": "Global (all projects)",
  "dialog.plugin.install.scope.local": "Local (this project)",
  "dialog.plugin.install.submit": "Install",
  "dialog.plugin.install.installing": "Installing…",
  "dialog.plugin.install.empty": "Plugin spec is required",
  "dialog.plugin.options.open": "Edit options for {{spec}}",
  "dialog.plugin.options.title": "Options for {{spec}}",
  "dialog.plugin.options.description": "Plugin options as a JSON object. Saving replaces the current options.",
  "dialog.plugin.options.label": "Options (JSON)",
  "dialog.plugin.options.invalid": "Options must be a JSON object",
  "dialog.plugin.options.count": "{{count}} options",
  "dialog.plugin.options.submit": "Save options",
  "dialog.plugin.options.clear": "Clear options",
  "toast.plugin.configured.title": "Updated {{spec}}",
  ...
  "settings.mcp.description": "Manage Model Context Protocol servers.",
