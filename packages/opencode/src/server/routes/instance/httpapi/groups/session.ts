    ...
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.post("share", SessionPaths.share, {
          ...
          error: [HttpApiError.InternalServerError, HttpApiError.Forbidden, ApiNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("shell", SessionPaths.shell, {
          ...
          success: described(SessionV1.WithParts, "Created message"),
          error: [HttpApiError.BadRequest, HttpApiError.Forbidden, ApiNotFoundError, SessionBusyError],
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("permissionRespond", SessionPaths.permissions, {
          ...
          error: [HttpApiError.BadRequest, HttpApiError.Forbidden, ApiNotFoundError, PermissionNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
